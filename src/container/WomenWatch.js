...
import { ItemBlog, menProduct, wonmenProduct } from "../ultils/constant";
import Product from "../componets/Product";

function WomenWatch() {
  return (
    <div className="flex bg-white justify-center">
      <div className="w-[70%] my-12 flex gap-4">
        ...
        <div className="w-[70%] border p-3 flex gap-2">
          {wonmenProduct &&
            wonmenProduct.map((item, index) => (
              <div className="w-[24%] introduce7">
